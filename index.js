...
loadAgendamentos();
  ...
  function renderDash(){
    document.getElementById('s-total').textContent=ag.length;
  ...
  function renderHist(){
    ...
    el.innerHTML=hist.length?hist.map(h=>'<div class="hist-item"><span class="hist-msg">↳ '+h.m+'</span><span class="hist-time">'+h.t+'</span></div>').join(''):'<div class="empty-msg">NENHUMA AÇÃO REGISTRADA</div>';
  }
